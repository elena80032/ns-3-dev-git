...
public:
  ...
  /**
   * \return A smart Socket pointer to a DccpSocket, allocated by this instance
   * of the DCCP protocol
   */
...
private:
   ...
   */
  DccpL4Protocol (const DccpL4Protocol &);
  /**
   * \brief Copy constructor
   *
   *
